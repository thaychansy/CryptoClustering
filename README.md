...
This unsupervised machine learning project aims to analyze and cluster cryptocurrencies using  Python and unsupervised learning to predict if cryptocurrencies are affected by 24-hour or 7-day price changes. As well as utlizing K-means clustering, employing data normalization and dimensionality reduction techniques such as Principal Component Analysis (PCA).
